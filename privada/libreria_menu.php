...
echo"<div id='header'>
	...
	echo"<ul>";
		...
		echo"</ul>";
			...
			if ($cuerp == false){
				echo"<a onclik='location.href=\"../claves/\"'><input type='button'name='accion' value='Cerrar Sesion' style='cursor:pointer;border-radius:10px;font-weight: bold;height: 25px;' class='boton_cerrar'></a>";
			}else{
				echo"<a onclick= 'location.href=\"claves/\"'><input type='button' name='accion' value='Cerrar Sesion' style='cursor:pointer;border-radius:10px;font-weight:bold;height: 25px; class='boton2'></a>";
	}
	echo"</ul>
	</div>";
