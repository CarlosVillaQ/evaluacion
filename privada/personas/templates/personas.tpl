			...
			<tr>
				...
				<td align="center">
					<form name="formElimi{$r.id_persona}" method="post" action="persona_eliminar.php">
						<input type="hidden" name="id_persona" value="{$r.id_persona}">
						<a href="javascript:document.formElimi{$r.id_persona}.submit();" title="Eliminar Persona Sistema" onclick="javascript:return(confirm('Desea realmente Eliminar a la persona.. {$r.nombres} {$r.ap}?')); location.href='persona_eliminar.php'">
							Eliminar>>
						</a>
					</form>
				</td>
