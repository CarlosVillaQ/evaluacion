	...
	<center>
		<table class="listado">
			...
			<tr>
				...
				<td align="center">
					<form name="forElimi{$r.id_usuario}" method="post" action="usuario_eliminar.php">
					<input type="hidden" name="id_usuario" value="{$r.id_usuario}">
					<a href="javascript:document.forElimi{$r.id_usuario}.submit();" title="Eliminar Usuario" onclick='javascript:return(confirm("Desea realmente Eliminar al usuario::: {$r.usuario_1}?"));'>Eliminar>></a>	
					</form>
				</td>
