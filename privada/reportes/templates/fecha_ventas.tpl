...
<head>
	...
	function validar(){
	   ...
	   ventanaCalendario = window.open("fecha_ventas1.php?fecha1=" +  fecha1 + "&fecha2=" +fecha2 , "calendario", "width=600, height=550,left=100,top=100,scrollbars=yes,menubars=no,statusbar=NO,status=NO,resizable=YES,location=NO")
	}
	</script>
	{/literal}
</head>
<body>
	<center>
		<br>
		<h1> REPORTES DE LAS FECHAS DE LAS VENTAS</h1>
